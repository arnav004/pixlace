...
export const metadata: Metadata = {
  title: "PixFit — Resize images to exact dimensions & file size",
  ...
  keywords: "image resizer, resize image KB, photo resize dimensions, passport photo resize, government portal photo",
  openGraph: {
    title: "PixFit — Resize images to exact dimensions & file size",
